...
//            var pr_baseline_price = "";
 var ListnoteSupl = "";
            line_items_data_table.find("tr").each(function() {
                ...
                var qty = $(this).find("td").children(".contract-line-item-qty").val();
                var contract_id = $(this).find("td").children(".contract-id").val();
                var contract_att_temp_id = $(this).find("td").children(".contract-att-temp").val();
//                var baseline_price = $(this).find("td").eq(12).children().val();
...
//                        enctype: 'multipart/form-data',
    ...
    var addVendorsDetailsModalTable = "";
    $("#addvendorsbtnfrommodal").click(function() {
        ...
        $.ajax({
            ...
            complete: function(responseJson) {
                var obj = $.parseJSON(responseJson.responseText);
                var venodorArr = obj.VendorArr;
                var VendorSapArr = obj.VendorSapArr;
                var ProspectArr = obj.ProspectArr;
                var SapVendorArr = obj.SapVendorJsonArr;

                console.log("venodorArr: " + venodorArr.length);
                console.log("VendorSapArr: " + VendorSapArr.length);
                console.log("ProspectArr: " + ProspectArr.length);
                console.log("SapVendorArr: " + SapVendorArr.length);
                ...
                for (var i = 0; i < VendorSapArr.length; i++)
                {
                    if (rfqVendorIdArray.length > 0)
                    {
                        if (rfqVendorIdArray.indexOf(VendorSapArr[i].id.toString()) === -1)
                        {
                            vendorRow += "<tr>"
                                    + "<td><input type='checkbox' class='select-vendor-from-modal' value='" + VendorSapArr[i].id + "'><input type='hidden' class='vendor-type' value='Vendor'></td>"
                                    + "<td>" + VendorSapArr[i].firstname + "</td>"
                                    + "<td>" + VendorSapArr[i].code + "</td>"
                                    + "<td></td>"
                                    + "<td>" + VendorSapArr[i].emailid + "</td>"
                                    + "<td>" + VendorSapArr[i].address + "</td>"
                                    + "<td>Vendor</td>"
                                    + "</tr>";
                        }
                    }
                ...
                for (var i = 0; i < ProspectArr.length; i++)
                {
                    if (rfqVendorIdArray.length > 0)
                    {
                        if (rfqVendorIdArray.indexOf(ProspectArr[i].id.toString()) === -1)
                        {
                            vendorRow += "<tr>"
                                    + "<td><input type='checkbox' class='select-vendor-from-modal' value='" + ProspectArr[i].id + "'><input type='hidden' class='vendor-type' value='Prospect'></td>"
                                    + "<td>" + ProspectArr[i].prospectvendorname + "</td>"
                                    + "<td></td>"
                                    + "<td></td>"
                                    + "<td>" + ProspectArr[i].emailid + "</td>"
                                    + "<td>" + ProspectArr[i].address + "</td>"
                                    + "<td>" + ProspectArr[i].type + "</td>"
                                    + "</tr>";
                        }
                    }
                    else
                ...
                for (var i = 0; i < SapVendorArr.length; i++)
                {
                    vendorRow += "<tr>"
                            + "<td><input type='checkbox' class='select-vendor-from-modal' value='" + SapVendorArr[i].vendorCode + "'><input type='hidden' class='vendor-type' value='SAP'></td>"
                            + "<td>" + SapVendorArr[i].vendorName + "</td>"
                            + "<td>" + SapVendorArr[i].vendorCode + "</td>"
                            + "<td>" + SapVendorArr[i].company + "</td>"
                            + "<td>" + SapVendorArr[i].mailId + "</td>"
                            + "<td>" + SapVendorArr[i].address1 + "," + SapVendorArr[i].address2 + "," + SapVendorArr[i].address3 + "</td>"
                            + "<td>SAP Vendor</td>"
                            + "</tr>";
                }
...
//    }
    ...
    $("#agreementdate").keydown(function() {
        return false;
    });
    ...
    $("#validitystartdate").keydown(function() {
        return false;
    });
    ...
    $("#validityenddate").keydown(function() {
        return false;
    });
   
   $("#uploadcontractlinefilesubmitbtn").click(function() {
//        alert($("input[name='file_docDiv1']").val());
//        $("#overlay").css("display", "block");
        if ($("input[name='file_docDiv1']").val().trim() !== "" || $("input[name='file_docDiv2']").val().trim() !== "" ||
                $("input[name='file_docDiv3']").val().trim() !== "" || $("input[name='file_docDiv4']").val().trim() !== "" ||
    ...
    $("#contractlinedocform").submit(function(event) {
...
//        $("#prlinedocform").prop("action", "submitrfqprlineattachment.do");
            ...
            $.ajax(
                    {
                        type: "POST",
                        url: "submitrfqcontractlineattachment.do",
                        async: true,
                        data: formData,
//                        enctype: 'multipart/form-data',
                        contentType: false,
                        ...
                        complete: function(responseJson)
                        {
                            ...
                            current_tr.find("td").eq(7).children(".contract-att-temp").val(obj.TempAttachmentId);
                            current_tr.find("td").eq(13).children(".viewContractUploadedDocFromDB").removeAttr("style");
//                        $("#prlineitemattachmentmodal").modal("hide");
                            console.log(current_tr.find("td").eq(13).children(".viewContractUploadedDocFromDB").html());
...
//                        $("#overlay").css("display", "none");
    ...
    $(".viewContractUploadedDocFromDB").click(function() {

        var prAttTempId = $(this).parent().parent().find("td").children(".contract-att-temp").val();
        console.log("pr_att_temp_id: " + prAttTempId);
    if (prAttTempId === "non" || prAttTempId === '')
        {
            Lobibox.alert("error", {
        ...
        else
        {
            ...
            $.ajax({
                ...
                async: true,
                data: {
                    "reqFrom": "GetDocumentsFromContractAttTemp",
                    "contractAttTempId": prAttTempId
                },
                complete: function(responseJson) {
                    var obj = $.parseJSON(responseJson.responseText);
                    ...
                    if (obj.Att1 !== undefined)
                        row += "<tr><td>" + obj.Att1 + "</td><td><a href='downloadDocFromContractAttTemp.do?attid=" + prAttTempId + "&attachmentno=att1' id='DownloadAtt1' class='downloadDocFromDB' title='Download'><i class='fas fa-download fa-x'></i></a></td><td><a href='#' id='DeleteAtt1_" + prAttTempId + "' class='deleteContractDocFromDB' title='Delete'><i class='fas fa-trash fa-x'></i></a></td></tr>";
                    if (obj.Att2 !== undefined)
                        row += "<tr><td>" + obj.Att2 + "</td><td><a href='downloadDocFromContractAttTemp.do?attid=" + prAttTempId + "&attachmentno=att2' id='DownloadAtt2' class='downloadDocFromDB' title='Download'><i class='fas fa-download fa-x'></i></a></td><td><a href='#' id='DeleteAtt2_" + prAttTempId + "' class='deleteContractDocFromDB' title='Delete'><i class='fas fa-trash fa-x'></i></a></td></tr>";
                    if (obj.Att3 !== undefined)
                        row += "<tr><td>" + obj.Att3 + "</td><td><a href='downloadDocFromContractAttTemp.do?attid=" + prAttTempId + "&attachmentno=att3' id='DownloadAtt3' class='downloadDocFromDB' title='Download'><i class='fas fa-download fa-x'></i></a></td><td><a href='#' id='DeleteAtt3_" + prAttTempId + "' class='deleteContractDocFromDB' title='Delete'><i class='fas fa-trash fa-x'></i></a></td></tr>";
                    if (obj.Att4 !== undefined)
                        row += "<tr><td>" + obj.Att4 + "</td><td><a href='downloadDocFromContractAttTemp.do?attid=" + prAttTempId + "&attachmentno=att4' id='DownloadAtt4' class='downloadDocFromDB' title='Download'><i class='fas fa-download fa-x'></i></a></td><td><a href='#' id='DeleteAtt4_" + prAttTempId + "' class='deleteContractDocFromDB' title='Delete'><i class='fas fa-trash fa-x'></i></a></td></tr>";
                    if (obj.Att5 !== undefined)
                        row += "<tr><td>" + obj.Att5 + "</td><td><a href='downloadDocFromContractAttTemp.do?attid=" + prAttTempId + "&attachmentno=att5' id='DownloadAtt5' class='downloadDocFromDB' title='Download'><i class='fas fa-download fa-x'></i></a></td><td><a href='#' id='DeleteAtt5_" + prAttTempId + "' class='deleteContractDocFromDB' title='Delete'><i class='fas fa-trash fa-x'></i></a></td></tr>";
                    console.log(row)
                    $("#documentListTable tbody").append(row);
                    $("#overlay").css("display", "none");
...
//                $("#showUploadedDocFromDBModal").modal("hide");
      ...
      $("#documentListTable").on("click", ".deleteContractDocFromDB", function() {
        console.log("deleteDocFromDB");
        var currentTR = $(this).parent().parent();
        console.log($(this).prop("id"));
        ...
        $.ajax({
            ...
            async: false,
            data: {
                "reqFrom": "DeleteDocumentsFromContractAttTemp",
                "attId": attId,
                "attNo": attNo
            },
            complete: function(responseJson) {
...
//    });
 ...
 var currentLineRow;
    ...
    $("#ratedParameterTable").on("change", "#ratedParameter", function() {
        currentLineRow = $(this).val();
         var row1=$(this).closest("tr").index();
        $('#ratedParameterTable tbody tr').each(function (row, tr) {
            if(row1 !=row){
            var ratedParameter=$(tr).find("td #ratedParameter").val();
            if(ratedParameter==currentLineRow ){
               alert("The Parameter Is Already Selected Kindly Select Other");
             $("#submitRatedParameterBtn").prop('disabled', true);

               
            }else{
                    $("#submitRatedParameterBtn").prop('disabled', false);
            }
        }
        });
    });
 ...
 $("#submitRatedParameterBtn").click(function() {
        ...
        $('#ratedParameterTable tbody tr').each(function (row, tr) {
            var ratedParameter=$(tr).find("td #ratedParameter").val();
            var ratedParameterWeight=$(tr).find("td #ratedParameterWeight").val();
            totalWeight=totalWeight+parseInt(ratedParameterWeight);
            param = param + "" + ratedParameter + ',' + ratedParameterWeight + "#";
        });
        console.log(param);
...
$("#addratedparameter").click(function() {
//    var ratedIndex = parseInt($("#ratedIndex").val());
//    $("#ratedIndex").val(ratedIndex+1);
    var tbody_tr="<tr><td><a href='#' title='Delete' class='delete-ratedparam-line'><i class='fas fa-trash-alt'></i></a></td>";
    
    console.log(document.getElementById("DefaultRatedParam").value);
    //var str=
   // tbody_tr=tbody_tr+"<td><input type='text' id='ratedParameter' name='ratedParameter' class='rated-parameter-weight-class'></td>";
    tbody_tr=tbody_tr+"<td><select class=' show-tick show-menu-arrow form-control' title='Choose Rated Parameter...' data-live-search-placeholder='Search' data-live-search='true' data-style='' data-width='100%' id='ratedParameter' name='ratedParameter'>";
    
   var param=document.getElementById("DefaultRatedParam").value;
   var a = param.split(","),
    i;
    tbody_tr=tbody_tr+"<option value='' >--Select--</option>";
for (i = 0; i < a.length; i++) {
     tbody_tr=tbody_tr+"<option value='"+a[i]+"' >"+a[i]+"</option>";
     }
     
      tbody_tr=tbody_tr+"</select></td>";
   //tbody_tr=tbody_tr+"<td>"+document.getElementById("PurchaseGroup")+"</td>";
    tbody_tr=tbody_tr+"<td><input type='number' min='0'  id='ratedParameterWeight' name='ratedParameterWeight' class='rated-parameter-weight-class'></td></tr>";
    
    $("#ratedParameterTable tbody").append(tbody_tr);
    //$("#ratedParameterTable").children("tbody").html(tbody_tr);
    
});

$("#ratedParameterTable").on("click", ".delete-ratedparam-line", function () {
        $(this).closest('tr').remove();
        $('#ratedParameterTable').focus();
