...
<html lang="en">
    ...
    <head>
        ...
        <title>Standalone PO Error Transactions</title>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        <h5 class="card-header bg-primary">Standalone PO Error Transactions</h5>
                                        <div class="card-body update-backgroud-color">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped createdPOTable" id="createdPOTable">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${errorTransactionsSAList}" var="extPo">
                                                            <tr>
                                                                <td>${extPo[0]}</td>
                                                                <td>${extPo[2]}</td>
                                                                <td>${extPo[1]}</td>
                                                                <td style="text-align: center;"><b>Error</b></td>
                                                                <td><a href='/BuyerPortal/createstandalonepo.do?type=edit&id=${extPo[3]}' title='Generate work item' class='btn btn-danger btn-sm edit-standalonepo'>Edit</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
                        ...
                        var table = $('table.createdPOTable').DataTable({
                            ...
                            buttons: [
                                {extend: 'collection',
                                    text: 'Export',
                                    buttons: [
                                        {extend: 'excel', title: 'Standalone PO Error Transactions'},
                                        {extend: 'pdf', title: 'Standalone PO Error Transactions'},
                                        {extend: 'print', title: 'Standalone PO Error Transactions'}
                                    ]
                                }
                            ]
                        });
