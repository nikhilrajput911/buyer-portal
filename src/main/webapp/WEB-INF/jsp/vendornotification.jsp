                ...
                <div class="main-container">
                    <div class="container-fluid dashboard-content ">
                        <div class="">
                            ...
                            <div class="navbar bg-white breadcrumb-bar border-bottom update-backgroud-color">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="vendors.do">Vendors</a>
                                        </li>
                                        <li class="breadcrumb-item">Vendor Notification
                                        </li>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body update-backgroud-color">
                                            <form action="makevendornotification.do" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                                <input type="hidden" name="vendorid" id="vendorid" value="">

                                                <div class="email editor update-backgroud-color">
                                                    ...
                                                    <div class="email action-send">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <button class="btn btn-default btn-space" type="button" id="cancelchatbtn"><i class="icon s7-close"></i> Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="media-body">
                                                                    <div class="chat-item-title">
                                                                        <!--<span class="chat-item-author">${notification.ngBpBuyerdetailsId.firstname}</span>-->
                                                                         <c:if test="${notification.commentby == 'Admin'}">
                                                                            <span class="chat-item-author">${notification.ngBpBuyerdetailsId.firstname}</span>
                                                                        </c:if>
