...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .vendorFinalizationTable thead th, .vendorcomparisonreporttable thead th, .documentListTable thead th{
                ...
                <div class="">
                    <div class="container-fluid dashboard-content ">
                        ...
                        <div class="">
                            ...
                            <div class="card">
                                 <form class="" method="post" action="createcontract.do" id="createcontractOLAForm">
                                <!--<form action="createcontract.do" id="contract_rfq_form" method="POST">-->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                            <input type="hidden" name="DefaultRatedParam" id="DefaultRatedParam" value="${ratedParam}">
                                             <input type="hidden" name="vendorIdlist" id="vendorIdlist" >
                                             <input type="hidden" name="param" id="param" >
                                              <input type="hidden" name="rating" id="rating" >
                                               ...
                                               <input type="hidden" name="vendorrfqlineID" id="vendorrfqlineID" >
                                                ...
                                                <a href="query.do" class="btn btn-primary btn-rounded btn-sm disabled" id="reponseManagementBtn" style="margin-top: 25px;">
                                                 ...
                                                 <a href="#" class="btn btn-primary btn-rounded btn-sm disabled" id="addNewRatedParameter" style="margin-top: 25px;">
                                                    <i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Rated Parameter 
                                                            ...
                                                            <!--<a href="createcontract.do?contractRefId=${contractRefID}&reqType=${reqType}">-->
                                                            <input type="button"  class="btn btn-primary btn-rounded" id="createOLABtn"  value="Create OLA" disabled="true">
                                                            <!--</a>-->
                                    ...
                                    <div class="tab-regular">
                                        <ul class="nav nav-tabs nav-fill" id="myTab7" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="vendorComparisonReport-tab-justify" data-toggle="tab" href="#vendorComparisonReport-justify" role="tab" aria-controls="vendorComparisonReport" aria-selected="true">Vendor Comparison Report</a>
                                            </li>
<!--                                            <li class="nav-item">
