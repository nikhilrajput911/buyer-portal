                                                ...
                                                <div>
                                                    ...
                                                    <div id="step-1" class="update-backgroud-color">
                                                        ...
                                                        <form action="submitrfqdetails.do" id="rfqdataform"  method="post">
                                                            ...
                                                            <input type="hidden" name="tempRfqId" id="tempRfqId" value="">
                                                                ...
                                                                <div class="form-group" id="addbtn">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-bordered table-hover line_items_data_table" id="line_items_data_table">
                                                                            ...
                                                                            <tbody>
                                                                                <c:forEach var="pr" items="${rfqPrLineItemBeanList}" varStatus="status">
                                                                                    <tr>
                                                                                        <td align="center">${pr.itemNumber}<input type="hidden" class="delDateAct" value="${pr.deliveryDateCategory}"></td>
                                                                                        ...
                                                                                        <td align="center">
                                                                                            <a href="#" class="matlLongTextClass" title="Long Text" data-toggle="tooltip" data-placement="auto">
                                                                                                <i class="fa fa-file" aria-hidden="true" style=""></i>
                                                                                            </a>
                                                                                        ...
                                                                                        <td><input type="hidden" class="pr-att-temp" value="non"/><input type="hidden" class="pr-id" value="${pr.insertionOrderId}"/><br><input class="pr-line-item-qty" type="text" min="1" max="<fmt:formatNumber type="number" minFractionDigits="3" value="${pr.remainingQuantity}"/>" value="<fmt:formatNumber type="number" minFractionDigits="3" value="${pr.remainingQuantity}"/>" style="width: 150px;"/> / ${pr.uomStore}</td>
                                                                                        ...
                                                                                        <td></td>
                                                                                        <td><input type="text" class="notesToSuppler" name="notesToSupplier"></td>
                                                                                        <td>${pr.noteToBuyer}</td>
                                                                                        <td align="center">${pr.miqaMaterial}</td>
                                                                                        <!--<td><input type="text" class="termsToSuppler" name="termsToSupplier"></td>-->
                                                                                        <td align="center">
                                                    ...
                                                    <div id="step-4" class="update-backgroud-color">
