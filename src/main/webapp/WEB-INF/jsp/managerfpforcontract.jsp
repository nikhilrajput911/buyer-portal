...
<html lang="en">
    ...
    <head>
        ...
        <title>Manage RFP for Contract</title>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        <h5 class="card-header bg-primary">Manage RFP for Contract</h5>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered rfpdetailstable" id="rfpdetailstable">
                                                    <thead class="">
                                                        <tr class="border-0">
