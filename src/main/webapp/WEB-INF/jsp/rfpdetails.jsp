                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">Manage RFP </h2>
                                    <!--<p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>-->
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item">RFP Management</li>
                                                <li class="breadcrumb-item active" aria-current="page"><a href="managerfp.do">Manage RFP</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="#" id="rfpdataform" method="post">
                                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                                <input type="hidden" name="ro_vendorname" id="ro_vendorname">
                                                <input type="hidden" name="rfq_operation" id="rfq_operation" value="rfq_details">
                                                <input type="hidden" name="isVendorNotified" id="isVendorNotified" value="${RfpHeader.notifyVendor}">
                                                <input type="hidden" name="rfpStatus" id="rfpStatus" value="${RfpHeader.rfpStatus}">
                                                <!-- SmartWizard html -->
                                                <div class="row">
                                                    ...
                                                    <div>
                                                        <div id="step-1" class="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="<fmt:formatDate value="${RfpHeader.rfqValidUntil}" pattern="dd.MM.yyyy"></fmt:formatDate>" class="form-control form-rounded" id="rfqvaliduntil" name="rfqvaliduntil" readonly>
                                                                            ...
                                                                            <!--                                                                            <div class="input-group date" id="rfqvaliduntil_div" data-target-input="nearest">
                                                                                                                                                            <input type="text" class="form-control datetimepicker-input manual-date-input-check" id="rfqvaliduntil" name="rfqvaliduntil" data-target="#TransactionInitiatedOn" value="<fmt:formatDate value="${RfpHeader.rfqValidUntil}" pattern="dd-MM-yyyy"/>" />
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="<fmt:formatDate value="${RfpHeader.expectedDeliveryDate}" pattern="dd.MM.yyyy"></fmt:formatDate>" class="form-control form-rounded" id="expecteddeliverydate" name="expecteddeliverydate" readonly>
                                                                            ...
                                                                            <!--                                                                        <div class="input-group date" id="expecteddeliverydate_div" data-target-input="nearest">
                                                                                                                                                        <input type="text" class="form-control datetimepicker-input manual-date-input-check" id="expecteddeliverydate" name="expecteddeliverydate" data-target="#expecteddeliverydate_div" value="<fmt:formatDate value="${RfpHeader.expectedDeliveryDate}" pattern="dd-MM-yyyy"/>" />
                                                                ...
                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" name="notifyvendor" id="notifyvendor" class="custom-control-input" disabled><span class="custom-control-label" required="">Yes</span>
                                                                        </label>
                                                                ...
                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                    <div class="form-group">
                                                                        <label for="rfqstatus" class="">RFP Status:</label>
                                                                        <input type="text" class="form-control form-rounded" id="" name="" value="${RfpHeader.rfpStatus}" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="form-group" id="addbtn">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-bordered rfp_line_items_data_table rfp_details_table" id="rfp_line_items_data_table">
                                                                                ...
                                                                                <tbody>
                                                                                    <c:forEach var="line" items="${rfpLineItemList}">
                                                                                        <tr>
                                                                                            <td>${line.itemNumber}</td>
                                                                                            <td>${line.plantMasterId.name}</td>
                                                                                            <td>${line.materialMatserId.materialCode} / ${line.materialMatserId.oldMaterialNo} / ${line.materialMatserId.shortText}</td>
                                                                                            <td>${line.plantMasterId.plantCode} / ${line.plantMasterId.plantDesc}</td>
                                                                                            <td><fmt:formatDate value="${line.deliveryDate}" pattern="dd.MM.yyyy"></fmt:formatDate> / </td>
                                                                                                <td>
                                                                                                    <a href="#" class="longTextClass" title="Long Text" data-toggle="tooltip" data-placement="auto">
                                                                                                        <i class="fa fa-file" aria-hidden="true"></i>
                                                                                                    </a>
                                                                                                    <input type="hidden" name="longTextHiddenClass" class="longTextHiddenClass" value="${line.materialMatserId.longText}">
                                                                                            </td>
                                                                                            <td></td>
                                                                                            <td>${line.materialMatserId.baseUOM}</td>
                                                                                            <td>${line.quantity} / </td>
                                                                                            <td>${line.localPurchase}</td>
                                                                                            <td>${line.materialMatserId.storageLocation}</td>
                                                                                            <td></td>
                                                                                            <td>${line.notesToSupplier}</td>
                                                                                            <td>${line.materialMatserId.countryOfOrigin}</td>
                                                                                        </tr>
                                                                                    </c:forEach>
                                                                                </tbody>
                                                                            </table>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <c:choose>
                                                                                            <c:when test="${vendormapping.status == 'Pending'}">
                                                                                                ...
                                                                                                <td><a href="vendorrfpdetails.do?vendorid=${vendormapping.ngBpVendordetailsId.id}&rfpid=${vendormapping.ngBpWorkorderrfpheaderId.id}" title="Check Details"><i class="fas fa-eye fa-lg"></i></a></td>
                                                                                                    </c:when>
                                                                                                    <c:otherwise>
                                                                                                <td><i class="fas fa-eye-slash fa-lg"></i></td>
                                                                                                </c:otherwise>    
