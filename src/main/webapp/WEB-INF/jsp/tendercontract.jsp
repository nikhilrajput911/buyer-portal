                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        <h5 class="card-header bg-primary">Tender Finalization</h5>
                                        <div class="card-body">
                                            ...
                                            <div class="tab-regular">
                                                ...
                                                <ul class="nav nav-tabs nav-fill" id="myTab7" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="rfqforcontract-tab-justify" data-toggle="tab" href="#rfqforcontract-justify" role="tab" aria-controls="rfqforcontract" aria-selected="true">Tender Finalization</a>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <div class="tab-pane fade show active" id="rfqforcontract-justify" role="tabpanel" aria-labelledby="rfqforcontract-tab-justify">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mytaskforcontract" id="mytaskforcontract">
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="rfqHeader" items="${contractRfqTenderList}" varStatus="status">
                                                                        <tr>
