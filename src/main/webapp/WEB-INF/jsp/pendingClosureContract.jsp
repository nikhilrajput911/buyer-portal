                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="tab-regular">
                                                            <ul class="nav nav-tabs nav-fill" id="myTab7" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" id="Service-tab-justify" data-toggle="tab" href="#Service-justify" role="tab" aria-controls="Service" aria-selected="true">Service</a>
                                                                </li>

                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="Material-tab-justify" data-toggle="tab" href="#Material-justify" role="tab" aria-controls="Material" aria-selected="false">Material</a>
                                                                </li>
                                                            </ul>

                                                            <div class="tab-content">
                                                                <div class="tab-pane fade show active" id="Service-justify" role="tabpanel" aria-labelledby="Service-tab-justify">
                                                                    <div class="table-responsive">
                                                                ...
                                                                <div class="tab-pane fade show" id="Material-justify" role="tabpanel" aria-labelledby="Material-tab-justify">
                                                                    <div class="table-responsive">
