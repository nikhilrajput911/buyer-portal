...
<html>
    <head>
        ...
        <title>Pending RFQ Closure PRs with RFQ created</title>
    </head>
    <body>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="pageheader">
                                    <h2 class="pageheader-title">Pending RFQ Closure PRs with RFQ created</h2>
                                                    ...
                                                    <div class="tab-regular">
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered table-striped pending-rfqClosure" id="pending_rfqClosure_Id" style="width:100%;">
                                                                    <thead class="">
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        <c:forEach var="pr" items="${rfqClosureList}" varStatus="status">
                                                                            <tr>
