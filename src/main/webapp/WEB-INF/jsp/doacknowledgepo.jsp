                                ...
                                <div class="page-header">
                                    <div class="row">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
                                            <h2 class="pageheader-title">Acknowledge PO </h2>
                                        </div>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item">Manage POs</li>
                                                <li class="breadcrumb-item"><a href="acknowledgepo.do">Acknowledge PO</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                                                ...
                                                                <div class="card-body border-top">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select data-placeholder="Select..." tabindex="1" class="custom-select dropdown-height" id="typeOfPOHeader" name="typeOfPOHeader" disabled="true">
                                                                        ...
                                                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="selectpicker show-tick show-menu-arrow form-control" title="Choose Code..." data-live-search-placeholder="Search" data-live-search="true" data-style="" data-width="100%" id="vendorcodeHeader" name="vendorcodeHeader" disabled="true">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                            ...
                                                                            <input type="text" class="form-control form-rounded" id="requestType" name="requestType" value="Acknowledge Purchase Order" readonly="true">
                                                                        </div>
                                                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                        ...
                                                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                            ...
                                                                            <select class="custom-select dropdown-height" id="referenceDocNumber" name="referenceDocNumber" disabled="true">
                                                                                <option value="">Select</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                            <label for="referenceDocLine">Reference Doc Line:</label>
                                                                            <select class="custom-select dropdown-height" id="referenceDocLine" name="referenceDocLine" disabled="true">
                                                                                <option value="">Select</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="custom-select dropdown-height" id="downPaymentReqd" name="downPaymentReqd" disabled="true">
                                                                                <option value="">Select</option>
                                                                                <option>Yes</option>
                                                                                <option>No</option>
                                                                            </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select data-placeholder="Select..." tabindex="1" class="custom-select dropdown-height payment-term-custom-select inline" id="paymentTermsDelivery" name="paymentTermsDelivery" style="width:240px;" disabled="true">
                                                                                <option value="">Select</option>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="custom-select" id="purchasingGroup" name="purchasingGroup" disabled="true">
                                                                            <option value="">Select</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="align-center text-align-center">
                                                    <input type="button" class="btn btn-success btn-rounded acknowledge-po" id="acknowledgePoBtn" value="Acknowledge PO" disabled="true">
                                                </div>
                                            </div>
                                        </div>   <br> 
                                        </form> 
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form action="uploadsignedpo.do" method="post" enctype="multipart/form-data" id="acknowledgeDocForm">
                            ...
                            <input type="hidden" name="ro_poNumber" value="${PoNumber}">
                            <div class="modal-header">
