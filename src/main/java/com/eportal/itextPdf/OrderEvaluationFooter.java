 ...
 * @author admin
 */
public class OrderEvaluationFooter extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        Phrase footer = new Phrase("Note: This evaluation is done by Procurement in consultation with Logistics", ffont);
