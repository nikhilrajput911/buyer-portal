 ...
 */
@Entity
@Table(name = "NG_BP_workorderattachment_temp")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "WorkOrderAttachmentTemp.findAll", query = "SELECT w FROM WorkOrderAttachmentTemp w"),
    @NamedQuery(name = "WorkOrderAttachmentTemp.findById", query = "SELECT w FROM WorkOrderAttachmentTemp w WHERE w.id = :id")})
public class WorkOrderAttachmentTemp implements Serializable {
    @Lob
    ...
    public WorkOrderAttachmentTemp() {
    }

    public WorkOrderAttachmentTemp(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WorkOrderAttachmentTemp)) {
            return false;
        }
        WorkOrderAttachmentTemp other = (WorkOrderAttachmentTemp) object;
