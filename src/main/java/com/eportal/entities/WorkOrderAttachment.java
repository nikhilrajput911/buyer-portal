 ...
 */
@Entity
@Table(name = "NG_BP_workorderattachment")
@XmlRootElement
@NamedQueries({
...
public class WorkOrderAttachment implements Serializable {
    ...
    @JoinColumn(name = "ng_bp_workorderrfqlineitem_rfqlineid", referencedColumnName = "RFQLineID")
    @ManyToOne
    private WorkOrderRfqLineItem ngBpWorkorderrfqlineitemRfqlineid;
...
//    }
    ...
    public WorkOrderRfqLineItem getNgBpWorkorderrfqlineitemRfqlineid() {
        return ngBpWorkorderrfqlineitemRfqlineid;
    }

    public void setNgBpWorkorderrfqlineitemRfqlineid(WorkOrderRfqLineItem ngBpWorkorderrfqlineitemRfqlineid) {
        this.ngBpWorkorderrfqlineitemRfqlineid = ngBpWorkorderrfqlineitemRfqlineid;
    }
