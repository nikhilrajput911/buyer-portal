 ...
 */
@Entity
public class PoSavingReportServiceBean implements Serializable{
    @Id
    ...
    public String getServiceShortText() {
        return serviceShortText;
    }

    public void setServiceShortText(String serviceShortText) {
        this.serviceShortText = serviceShortText;
    }
