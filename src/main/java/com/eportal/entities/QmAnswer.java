...
public class QmAnswer implements Serializable {
    ...
    @JoinColumn(name = "NG_BP_QM_Question_id", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private QmQuestion bPaasQMQuestionid;
    @JoinColumn(name = "NG_BP_UserDetail_userid", referencedColumnName = "userid")
    @ManyToOne(optional = false)
