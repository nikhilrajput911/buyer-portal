 ...
 */
@Entity
@Table(name = "ng_bp_rfqheader_vendormapping")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RfqHeaderVendorMapping.findAll", query = "SELECT r FROM RfqHeaderVendorMapping r"),
    @NamedQuery(name = "RfqHeaderVendorMapping.findById", query = "SELECT r FROM RfqHeaderVendorMapping r WHERE r.id = :id")})
public class RfqHeaderVendorMapping implements Serializable {
    ...
    public RfqHeaderVendorMapping() {
    }

    public RfqHeaderVendorMapping(Integer id) {
        this.id = id;
    }
