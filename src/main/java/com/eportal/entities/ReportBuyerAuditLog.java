 ...
 */
@Entity
@Table(name = "NG_BP_Report_BuyerAuditLog")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ReportBuyerAuditLog.findAll", query = "SELECT b FROM ReportBuyerAuditLog b"),
    @NamedQuery(name = "ReportBuyerAuditLog.findById", query = "SELECT b FROM ReportBuyerAuditLog b WHERE b.id = :id")
})
public class ReportBuyerAuditLog implements Serializable {
    ...
    public ReportBuyerAuditLog() {
    }

    public ReportBuyerAuditLog(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReportBuyerAuditLog)) {
            return false;
        }
        ReportBuyerAuditLog other = (ReportBuyerAuditLog) object;
    ...
    public String toString() {
        return "com.eportal.entities.ReportBuyerAuditLog[ id=" + id + " ]";
    }
