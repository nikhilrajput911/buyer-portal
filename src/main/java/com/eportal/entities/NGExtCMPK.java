 ...
 */
@Embeddable
public class NGExtCMPK implements Serializable {
    ...
    public NGExtCMPK(String itemIndex, String itemType) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NGExtCMPK)) {
            return false;
        }
        NGExtCMPK other = (NGExtCMPK) object;
    ...
    public String toString() {
        return "com.eportal.entities.NGExtCMPK[ itemIndex=" + itemIndex + ", itemType=" + itemType + " ]";
    }
