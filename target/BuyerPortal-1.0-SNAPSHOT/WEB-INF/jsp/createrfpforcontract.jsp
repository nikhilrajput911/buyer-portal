...
<html>
    <head>
        ...
        <title>Create RFP for Contract</title>
    </head>
    <body>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">Create RFP for Contract</h2>
                                    <!--<p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>-->
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item">RFP Management</li>
                                                <li class="breadcrumb-item active" aria-current="page">Create RFP for Contract</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="submitrfpcontractdetails.do" id="rfpcontractdataform" method="post">
                                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">

                                                <input type="hidden" name="ro_vendorname" id="ro_vendorname">
                                                <input type="hidden" name="rfq_operation" id="rfq_operation" value="create_rfp_contract">
                                                ...
                                                <div id="smartwizard">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="step-3" class="">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-3 col-3">
                                                                    <button type="button" style="margin-top: 25px;" class="btn btn-outline-primary btn-sm btn-rounded" id="addvendorsbtnfrommodal" data-toggle="modal" data-target="#addVendorsDetailsModal">Add Vendor</button>
                                                                    <button type="button" style="margin-top: 25px;" class="btn btn-outline-primary btn-sm btn-rounded" id="associateGroupBtnId" data-toggle="modal" data-target="#associategroupmodal">Create Vendor Group</button>
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                <label for="comment" class="">Comments:</label><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-parsley-length="[10,110]" class="form-control form-rounded" id="contactfirstname" name="contactfirstname" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
        ...
        <script src="assets/js/createrfqcontract.js"></script>
