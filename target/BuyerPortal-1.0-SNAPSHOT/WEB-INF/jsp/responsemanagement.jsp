                ...
                <div class="main-container">
                    <div class="container-fluid dashboard-content ">
                        <div class="">
                            ...
                            <input type="hidden" name="RfqId" id="RfqId" value="${RfqId}">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body update-backgroud-color">
                                            <form action="makenotification.do" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="mappingId" id="mappingId" value="${mappingId}">
                                                    ...
                                                    <div class="email action-send">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <button class="btn btn-success btn-space" type="button" id="rfqDetailsBtn">RFQ Details </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
//            location.reload(true);
            $("#rfqDetailsBtn").click(function() {
                ...
                location.href = "rfqdetails.do?rfqid=" + RfqId;
            });
