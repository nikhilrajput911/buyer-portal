                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group two">
                                                    ...
                                                    <input type="text" class="form-control form-rounded inline" id="conditionBaseRate" name="conditionBaseRate" readonly style="width: 200px;margin-left: 15px;">&nbsp 
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group two">
                                                    ...
                                                    <input type="text" class="form-control form-rounded inline" id="vendorCondition" name="vendorCondition" style="width: 100px;margin-left: 15px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group two">
                                            ...
                                            <input type="text" class="form-control form-rounded inline" id="accountAssignuom" name="" style="width:55px;height:25px;" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div class="row">
                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12">
                    <div class="form-group">
                        <a><i type="button" class="fas fa-plus-circle btn-primary btn-sm" id="addRowServiceAccAsgnTblBtnId" style="margin-left: 20px;margin-top:10px;display: none"></i></a>
                    </div>
                </div> 
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
...
<div class="modal fade" id="amendEditPoItemCategoryModal" tabindex="-1" role="dialog" aria-labelledby="amendEditPoItemCategoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="amendEditPoItemCategoryModalLabel">Item Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered amendEditPoItemCategoryModalTable" id="amendEditPoItemCategoryModalTable" style="width: 100%">
                                <thead class="">
                                    <tr class="">
                                        <th class="border-1" scope="col" style="width:50px;">Item Category Code</th>
                                        <th class="border-1" scope="col">Item Category  Desc</th>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group two">
                                            ...
                                            <input type="text" class="form-control form-rounded inline" id="limitAccountAssignQuantity" name="limitAccountAssignQuantity" style="width:150px;margin-left: 45px;height:25px;" disabled>
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div><hr style="margin-top:0rem;margin-bottom:0rem">
                                                ...
                                                <label class="custom-control custom-radio ">
                                                    <input type="radio" name="limitDistributionIndicator" id="limitDistOnQuantBases" class="custom-control-input" disabled="true"><span class="custom-control-label">Distribution On Quantity</span>
                                                </label>
                                                <label class="custom-control custom-radio ">
...
<div class="modal fade" id="PurchaseOrgModal" tabindex="-1" role="dialog" aria-labelledby="PurchaseOrgLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="PurchaseOrgLabel">Purchase Organization</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="SalesOrderModal" tabindex="-1" role="dialog" aria-labelledby="SalesOrderLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="SalesOrderLabel">Sales Order</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="ConditionTypeModal" tabindex="-1" role="dialog" aria-labelledby="ConditionTypeLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ConditionTypeLabel">Condition Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="VendorMasterModalHeader" tabindex="-1" role="dialog" aria-labelledby="VendorMasterModalHeaderLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="VendorMasterModalHeaderLabel">Vendor Master</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered vendorMasterModalHeaderTable" id="vendorMasterModalHeaderTable" style="width: 100%">
                                <thead class="">
                                    <tr class="">
                                        <th class="border-1" scope="col">Vendor Code</th>
                                        <th class="border-1" scope="col">Vendor Name</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="uploadsignedpo.do" method="post" enctype="multipart/form-data" id="acknowledgeDocForm">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                <input type="hidden" name="ro_pid" value="">
                <input type="hidden" name="ro_poNumber" value="">
                <div class="modal-header">
...
<div class="modal fade" id="DeletePrLineModal" tabindex="-1" role="dialog" aria-labelledby="DeletePrLineModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DeletePrLineModalLabel">PO Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover deletePrLinePoTable" id="deletePrLinePoTable">
                        <thead>
                            <tr class="border-0">
                                <th class="border-0"></th>
                                <th class="border-0">PO Number</th>
                                <th class="border-0">PR Number</th>
                                <th class="border-0">PR Item Number</th>
...
<div class="modal fade" id="ConditionTypeHeaderModal" tabindex="-1" role="dialog" aria-labelledby="ConditionTypeHeaderLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="clearConitionTypeModalBtn">Clear</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editAmendPoCommentsModal" tabindex="-1" role="dialog" aria-labelledby="editAmendPoCommentsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAmendPoCommentsModalLabel">Comments</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <textarea class="form-control rounded-0" id="poComments" name="poComments" rows="5" required></textarea>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="editAmendPoCommentsModalBtn">Submit</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="newPrLineModal" tabindex="-1" role="dialog" aria-labelledby="newPrLineModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newPrLineModalLabel">PR Lines</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered newPrLineModalTable" id="newPrLineModalTable">
                        <thead>
                            <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-secondary" id="newPrLineModalAddBtn">Add</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="rfqHeaderModal" tabindex="-1" role="dialog" aria-labelledby="rfqHeaderModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rfqHeaderModalLabel">RFQs</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered rfqHeaderModalTable" id="rfqHeaderModalTable">
                        <thead>
                            <tr>
                                <th class="noExport border-0"></th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-secondary" id="rfqHeaderModalAddBtn">Add</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="EditAndAmendPoMatlGroupModal" tabindex="-1" role="dialog" aria-labelledby="EditAndAmendPoMatlGroupModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EditAndAmendPoMatlGroupModalLabel">Material Group</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover EditAndAmendPoMatlGroupTableId" id="EditAndAmendPoMatlGroupTableId" style="width: 100%">
                                <thead class="">
                                    <tr class="">
                                        <th style="width:50px;"></th>
                                        <th class="border-1" scope="col" style="width:50px;">Material Group Code &nbsp;&nbsp;</th>
...
<div class="modal fade" id="rfqLineModal" tabindex="-1" role="dialog" aria-labelledby="rfqLineModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rfqLineModalLabel">RFQ Lines</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered rfqLineModalTable" id="rfqLineModalTable">
                        <thead>
                            <tr>
                                <th class="noExport border-0"></th>
                                <th class="border-0">RFQ Number</th>
                                ...
                                <th class="border-0">Remaining Quantity</th>
                                <th class="border-0">Purchase Request Number</th>
                                <th class="border-0">Material Code</th>
                                <th class="border-0">Material Group</th>
                                <th class="border-0">Short Text</th>
                            </tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-secondary" id="rfqLineModalAddBtn">Add</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document" style="max-width: 90%!important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea class="form-control rounded-0" id="serviceShortText" name="serviceShortText" rows="20" disabled="true" required></textarea>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="serviceShortTextModalSubmitBtn" style="display: none;">Submit</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document" style="max-width: 90%!important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea class="form-control rounded-0" id="serviceText" name="serviceText" rows="20" disabled="true" required></textarea>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="serviceTextModalSubmitBtn" style="display: none;">Submit</button>
            </div>
        </div>
    </div>
</div>
