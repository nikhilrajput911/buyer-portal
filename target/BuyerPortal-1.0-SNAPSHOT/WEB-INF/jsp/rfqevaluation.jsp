...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .vendorComparisonFinalizationReportTable thead th, .documentListTable thead th, .lastPoDetailsTable thead th, .viewRatedParameterAndScoreModalTable thead th{
    ...
    <body>
            ...
            <div class="dashboard-wrapper">
                <div class="">
                    <div class="container-fluid dashboard-content ">
                        ...
                        <input type="hidden" name="rfqIds" id="rfqIds">
                        ...
                        <div class="">
                            ...
                            <div class="card">
                                <h5 class="card-header bg-primary">RFQ Evaluation</h5>
                                <div class="card-body update-backgroud-color">
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="rfqEvalNumber" class="">RFQ Number: </label>
                                                <select multiple class="selectpicker show-tick show-menu-arrow" id="rfqEvalNumber" name="rfqEvalNumber" title="Choose RFQ(s)..." data-live-search-placeholder="Search" data-live-search="true" data-style="" data-width="100%">
                                        ...
                                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="rfqVendorList" class="">PO Vendor: </label>
                                                <select class="selectpicker show-tick show-menu-arrow" id="rfqVendorList" name="rfqVendorList" title="Choose any vendor..." data-live-search-placeholder="Search" data-live-search="true" data-style="" data-width="100%">
                                        ...
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                            <div class="form-group">
                                                <button style="margin-top: 25px;" class="btn btn-success btn-sm" id="generateRfqEvaluationReport" disabled="true">Generate Report</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-brand btn-rounded" id="createPoBtn" style="margin-top: 25px;" disabled="true"><i class="fa fa-file" aria-hidden="true"></i> Create PO</button>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered vendorComparisonFinalizationReportTable" id="vendorComparisonFinalizationReportTable">
                                                    <thead>
        ...
        <div class="modal fade" id="viewRatedParameterAndScoreModal" tabindex="-1" role="dialog" aria-labelledby="viewRatedParameterAndScoreModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document" style="max-width: 80%">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewRatedParameterAndScoreModalLabel">Rated Parameter & Score</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <input type='hidden' id='rfqId_RP_Modal'>
                        <input type='hidden' id='supplierId_RP_Modal'>
                        <input type='hidden' id='supplierHeaderId_RP_Modal'>
                        <input type='hidden' id='supplierLineItemId_RP_Modal'>
                        <input type='hidden' id='insertionOrderId_RP_Modal'>
                        <div class="table-responsive">
                            <table class="table table-bordered viewRatedParameterAndScoreModalTable" id="viewRatedParameterAndScoreModalTable">
                                <thead>
                                    <tr>
                                        <th>Rated Parameter</th>
                                        <th>Score</th>
                                        <th>Weight</th>
                                        <th>Description</th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="MoqMovRP">
                                            <select class='custom-select rated-parameter-score'>
                                        ...
                                        <td><span class='rated-parameter-weight'></span></td>
                                        <td style="text-align: center;">
                                            <input type="hidden" class="rated-parameter-type" value="MoqMovRP">
                                            <textarea cols='80' rows="3" class='rated-parameter-description'>                                                
                                            </textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="DeliveryLeadTimeRP">
                                            <select class='custom-select rated-parameter-score'>
                                                <option value=''>Select Score</option>
                                                <option value='5'>5 - Score</option>
                                                <option value='4'>4 - Score</option>
                                    ...
                                    <tr>
                                        <td>Payment Terms</td>
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="PaymentTermsRP">
                                            <select class='custom-select rated-parameter-score'>
                                                <option value=''>Select Score</option>
                                                <option value='5'>5 - Score</option>
                                                <option value='4'>4 - Score</option>
                                    ...
                                    <tr>
                                        <td>Brand/ Model</td>
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="BrandModelRP">
                                            <select class='custom-select rated-parameter-score'>
                                                <option value=''>Select Score</option>
                                                <option value='5'>5 - Score</option>
                                                <option value='4'>4 - Score</option>
                                    ...
                                    <tr>
                                        <td>Incoterms</td>
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="IncotermsRP">
                                            <select class='custom-select rated-parameter-score'>
                                                <option value=''>Select Score</option>
                                                <option value='5'>5 - Score</option>
                                                <option value='4'>4 - Score</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" class="rated-parameter-type" value="ValidityOfOfferRP">
                                            <select class='custom-select rated-parameter-score'>
                                                <option value=''>Select Score</option>
                                                <option value='5'>5 - Score</option>
                                                <option value='4'>4 - Score</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id='addNewRatedParameter'><i class="fa fa-plus-circle" aria-hidden="true"></i> New Rated Parameter </button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        ...
        <script src="assets/js/rfqevaluation.js"></script>
