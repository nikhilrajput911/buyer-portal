                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">RFQ In-Progress</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="table-responsive">
                                                    <table class="table table-striped rfq-in-progress" id="rfq_in_progress">
                                                        <thead class="">
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="pr" items="${RfqInitiatedPrList}" varStatus="status">
                                                                <tr>
