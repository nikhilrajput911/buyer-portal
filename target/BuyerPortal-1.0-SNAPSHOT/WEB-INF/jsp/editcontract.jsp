            ...
            <div class="dashboard-wrapper">
                <div class="">
                    <div class="container-fluid dashboard-content ">
                        <input type="hidden" id="contractID" value="${contractID}" name="contractID">
                        <input type="hidden" id="reqType" value="${Type}" name="reqType">
                        <!-- ============================================================== -->
                        <!-- pageheader  -->
                        <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <c:if test="${ContractFrom == 'EditContract'}">
                                    <h2 class="pageheader-title">Edit Contract</h2>
                                    </c:if>
                                    <c:if test="${ContractFrom == 'Amend Contract'}">
                                    <h2 class="pageheader-title">Amend Contract</h2>
                                    </c:if>
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="manageola.do" title="Back" class="breadcrumb-link">Manage Contract / Contract</a></li>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="editcontract.do" id="editcontractform" method="post">
                                                ...
                                                <input type="hidden" id="rfqid" name="rfqid" value="${rfqHeaderObj.rfqid}">
...
<!--                                                            <select id="companyCode" class="custom-select">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-rounded" id="requestType" name="requestType" value="${contract.requestType}" disabled />
<!--                                                            <select id="companyCode" class="custom-select">
...
<!--                                                            <select id="contract_type" class="custom-select">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-rounded" id="vendorname" name="vendorname" value="${contract.vendorName} " disabled />
<!--                                                            <select id="contract_type" class="custom-select">
                                                                <option>Standard Service Contract</option>
                                                            </select>-->
                                                        </div>
...
<div class="row">
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-rounded" id="vendorcode" name="vendorcode" value="${contract.vendorCode}" disabled />
<!--                                                            <select id="contract_type" class="custom-select">
                                                                <option>Standard Service Contract</option>
                                                            </select>-->
                                                        </div>
                                                                            ...
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-rounded" id="rfqno" name="rfqno"value="${contract.rFQNo}" disabled>
                                                                                </div>
                                                                            </div>
                                                                                 <c:if test="${ContractFrom == 'Amend Contract'}">
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    <label for="contractNo" class="">Contract Number</label>
                                                                                    <input type="text" class="form-control form-rounded" id="contractNo" name="contractNo">
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <button class="btn btn-primary" id="fetchOLA" type="button">Fetch OLA</button> 
                                                                                </div>
                                                                            </div>
                                                                                 </c:if>
<!--                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group date" id="rfqdate_div" data-target-input="nearest">
                                                                                        <input type="text" class="form-control datetimepicker-input manual-date-input-check" value="<fmt:formatDate value="${contractVendorRfqLineItem.get(0).contractVendorRfqHeaderId.ngBpContractRfqHeaderRfqid.rfqRequestDate}" pattern="dd-MM-yyyy"></fmt:formatDate>" readonly  disabled id="rfqdate" name="rfqdate" />
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane fade show active" id="generaldata-justify" role="tabpanel" aria-labelledby="generaldata-tab-justify">
                                                                    <!--    <div class="row">
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    <label for="agreementno" class="">Agreement Number</label>
                                                                                    <input type="text" class="form-control form-rounded" id="agreementno" name="agreementno">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    <label for="rfqno" class="">RFQ Number</label>
                                                                                    <input type="text" class="form-control form-rounded" id="rfqno" name="rfqno">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group date" id="rfqdate_div" data-target-input="nearest">
                                                                                        <input type="text" class="form-control datetimepicker-input manual-date-input-check" id="rfqdate" name="rfqdate" />
                                                                                        <div class="input-group-append" data-target="#rfqdate_div" data-toggle="datetimepicker">
                                                                                            <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    <label for="finalizedvendorcode" class="">Finalized Vendor Code</label>
                                                                                    <input type="text" class="form-control form-rounded" id="finalizedvendorcode" name="finalizedvendorcode">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                    <label for="finalizedvendorname" class="">Finalized Vendor Name</label>
                                                                                    <input type="text" class="form-control form-rounded" id="finalizedvendorname" name="finalizedvendorname">
                                                                                </div>
                                                                            </div>
                                                                        </div>-->
                                                                    <div class="card">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderAgInfoList.size() == 0 ? '' :  cmHeaderAgInfoList.get(0).getFinalAgreementValue()}" id="finalagreementvalue" name="finalagreementvalue" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                ...
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="input-group date" id="agreementdate_div" data-target-input="nearest">
                                                                                            <input type="text" class="form-control datetimepicker-input manual-date-input-check" value="${cmHeaderAgInfoList.size() == 0 ? '' :  cmHeaderAgInfoList.get(0).getAgreementDate()}" id="agreementdate" name="agreementdate" readonly/>
                                                                                ...
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="input-group date" id="validitystartdate_div" data-target-input="nearest">
                                                                                            <input type="text" class="form-control datetimepicker-input manual-date-input-check" value="${cmHeaderAgInfoList.size() == 0 ? '' :  cmHeaderAgInfoList.get(0).getValidityStartDate()}" id="validitystartdate" name="validitystartdate" readonly/>
                                                                                ...
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="input-group date" id="validityenddate_div" data-target-input="nearest">
                                                                                            <input type="text" class="form-control datetimepicker-input manual-date-input-check" value="${cmHeaderAgInfoList.size() == 0 ? '' : cmHeaderAgInfoList.get(0).getValidityEndDate()}" id="validityenddate" name="validityenddate" readonly/>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getPaymentIn()}" id="paymentindays" name="paymentindays">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="paymentinperc" class="">Payment In (%)</label>
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getPaymentInPerc()}" id="paymentinperc" name="paymentinperc">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="paymentindays2" class="">Payment In (Days)</label>
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getPaymentInDaysNet()}" id="paymentindays2" name="paymentindays2">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="paymentinperc2" class="">Payment In (%)</label>
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getPaymentInPerc()}" id="paymentinperc2" name="paymentinperc2">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getPaymentInDaysNet()}" id="paymentindaysnet" name="paymentindaysnet">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="ExchangeRate" class="">Exchange Rate</label>
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getExchangeRate()}" id="ExchangeRate" name="ExchangeRate">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label class="custom-control custom-checkbox">
                                                                                           <c:choose>
                                                                                                    <c:when test="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getExchangeRateFixed() =='on'}">
                                                                                ...
                                                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-rounded inline" id="IncoTermsPart1" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getIncotermsPart1()}" name="IncoTermsPart1" style="width: 50px;margin-left: 32px;" data-parsley-trigger="change" data-parsley-maxlength="3" required="true">
                                                                                ...
                                                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-rounded" value="${cmHeaderTermsDPInfoList.size() == 0 ? '' : cmHeaderTermsDPInfoList.get(0).getIncotermsPart2()}" id="IncotermsPart2" name="IncotermsPart2">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
<!--                                                                                        <select id="SupplVendor" name="SupplVendor" class="custom-select">
                                                                ...
                                                                <div class="tab-pane fade show" id="datadetails-justify" role="tabpanel" aria-labelledby="datadetails-tab-justify">
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-bordered" id="contractItemTableId" style="width: 95%; margin-left: 2%;">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <c:if test="${newgenContractLineItemList.size() > 0}">
                                                                                                <c:forEach var="Cont" items="${newgenContractLineItemList}" varStatus="status">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td> <input type="hidden" class="form-control form-rounded linkIdClass tableInputField"  id="linkId" name="linkId" value="${Cont.linkid}">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control form-rounded lineItemNumberServices tableInputField" disabled="true" value="${Cont.itemNumber}" id="itemnumber" name="itemnumber"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded accountAssignmentClass tableInputField" id="accassignment" value="${Cont.accountAssignment}"  name="accassignment"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded itemCategoryClass tableInputField" id="itemcategory" value="${Cont.itemCategory}"  name="itemcategory" disabled></td>
                                                                                                        <td><input type="text" class="form-control form-rounded materialCodeClass tableInputField" id="materialCode" value="${Cont.materialCode}"  name="materialCode"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded shortTextClass tableInputField check-negative-value" value="${Cont.shortText}"  min="0" id="shorttext" name="shorttext"></td>
                                                                                                        <td><input type="number" class="form-control form-rounded targQtyClass tableInputField" id="targQty" value="${Cont.targetedQuantity}"  name="targQty"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded matlLongtxtClass tableInputField" id="matllongtext" value="${Cont.matlLongText}"  name="matllongtext"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded uomClass tableInputField check-negative-value" min="0" value="${Cont.uoM}"  id="uom" name="uom"></td>
                                                                                                        <td><input type="number" class="form-control form-rounded perUnitClass tableInputField" id="ppu" value="${Cont.perPriceUnit}"  name="ppu"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded orderPriUnClass tableInputField check-negative-value" value="${Cont.orderPriceUnit}"  id="opu" name="opu"></td>
                                                                                                        <td><input type="number" class="form-control form-rounded netPriceClass tableInputField" id="np" value="${Cont.netPrice}"  name="np"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded materialGrpClass tableInputField" id="matlgroup" value="${Cont.matlGroup}"  name="matlgroup"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded plantClass tableInputField" id="plant" value="${Cont.plant}"  name="plant"></td>
                                                                                                        <td><input type="text" class="form-control form-rounded SlocClass tableInputField" id="Sloc" value="${Cont.storageLocation}"  name="Sloc"></td>
                                                                        ...
                                                                        <div class="tab-regular" style="width: 95%;margin-left: 2%;display: none;" id="lineItemInfoTab">
                                                                            ...
                                                                            <div class="tab-content">
                                                                                 <c:if test='${reqType == "Material"}'>
                                                                                     <div class="tab-pane fade show active" id="accountassignment-justify" role="tabpanel" aria-labelledby="accountassignment-tab-justify" style="width: 95%; margin-left: 2%;">
                                                                    ...
                                                                    <!--</div>-->
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="tab-pane fade show" id="texts-justify" style="width: 95%; margin-left: 2%;" role="tabpanel" aria-labelledby="texts-tab-justify">
                                                                                    <div class="row">
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group date" id="ActivationDate_div" data-target-input="nearest">
                                                                                <input type="text" class="form-control datetimepicker-input manual-date-input-check" id="ActivationDate" name="ActivationDate" value="${cmSOWContractDetailsInfo.getActivationDate()}" readonly/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="align-center text-align-center">
                                                            ...
                                                            <input type="submit" class="btn btn-success btn-rounded editRFQOLA" id="editRFQOLA"  value="Edit OLA" style="">
                                                            <input type="submit" class="btn btn-success btn-rounded cancelRFQOLA" style="background-color: red;" id="cancelRFQOLA"  value="Cancel OLA" style="">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                 ...
                 var pid = $("#contractID").val();
                console.log("ContractID -> -> "+ pid);
