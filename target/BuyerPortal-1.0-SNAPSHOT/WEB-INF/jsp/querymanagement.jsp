...
<html lang="en">
    ...
    <body>
        ...
        <div class="dashboard-main-wrapper">
                ...
                <div class="">
                    <div class="container-fluid dashboard-content ">
                        <div class="">
                            ...
                            <div class="card">
                                <h5 class="card-header bg-primary">Response Management</h5>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker show-tick show-menu-arrow" id="rfqnumber" name="rfqnumber" title="Choose any RFQ..." data-live-search-placeholder="Search" data-live-search="true" data-style="" data-width="100%">
                                                    <c:forEach var="rfqHeader" items="${RfqHeaderList}" varStatus="status">
                                                        <option value="${rfqHeader.rfqid}">${rfqHeader.rfqNumber}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-align-right">
                                            <button id="sendMessageToAllBtn" data-toggle="modal" data-target="#sendMessageToAllModal" class="btn btn-outline-primary btn-rounded hidden" title="Send message to all vendors of this RFQ.">Send Message To All</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover" id="mytasktable">
            ...
            <!-- end wrapper  -->
            <!-- ============================================================== -->
            <div class="modal fade" id="sendMessageToAllModal" tabindex="-1" role="dialog" aria-labelledby="sendMessageToAllLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <form id="sendmessagetoallform" action="makenotificationtoallvendors.do" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                    <input type="hidden" name="rfqid" id="rfqid" value="">
                                    <input type="hidden" name="vendorids" id="vendorids" value="">
                                    <input type="hidden" name="mappingIds" id="mappingIds" value="">
                                    <div class="row">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="sendMessageToAllModalBtn">Send</button>
                        </div>
                    </div>
                </div>
            </div>
